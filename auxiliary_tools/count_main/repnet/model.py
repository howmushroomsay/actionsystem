...
class RepNet(nn.Module):
    ...
    def _init_encoder() -> nn.Module:
        ...
        encoder = torch.hub.load('./auxiliary_tools/count_main/pytorch-image-models', 'resnetv2_50',
                                 source='local',
                                 )
        # torch.save(encoder, './checkpoints/resnet50v2.pt')
        # encoder = torch.load('./checkpoints/resnet50v2.pt',)
